...
export class InteractiveTerminal {
    ...
    printProjects() {
        ...
        this.writeLine('');
        this.writeLine('2. CLOUD LOGIN ANOMALY DETECTION: Cybersecurity AI System (Sep 2025)', 'text-purple');
        ...
        this.writeLine('');
        this.writeLine('4. MOVIE RECOMMENDATION SYSTEM: Semantic Movie Recommender (Mar 2025)', 'text-blue');
        ...
        this.writeLine('');
        this.writeLine('5. ECOROUTE: Green Navigation Pathway Planner (Jun 2025)', 'text-green');
        this.writeLine('   - Objective: Map greenest, fuel-efficient paths between coordinates.');
        this.writeLine('   - Tech: React, Leaflet Map Matrix, Vite Build Engine.');
        this.writeLine('');
        this.writeLine('6. ROOMFIX: Hostel Complaint DBMS (Apr 2026)', 'text-cyan');
        this.writeLine('   - Objective: Connect hostel residents with administration for real-time complaints management.');
        this.writeLine('   - Tech: React/Angular, DBMS / SQL, Vercel.');
        this.writeLine('');
